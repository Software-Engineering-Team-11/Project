...
from supabase_manager import supabase,create_client, add_user_to_soup, print_database_content
...
def build_root() -> tk.Tk:
    ...
    if os.name != "posix":
        ...
        try:
            root.iconbitmap("/Users/rafaelbalassiano/Desktop/LASER_TAG/Project/images/logo.jpg") 
        except:
            root.iconbitmap("/Users/rafaelbalassiano/Desktop/LASER_TAG/Project/images/logo.jpg") 
